...
$packageName= 'resharper-ultimate-all' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'resharper-ultimate-all*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
